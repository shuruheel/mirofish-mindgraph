...
Used for server-side persistence of project state, avoiding large data transfers between API calls
"""
...
class Project:
    ...
    # Data source: "upload" (build graph from uploaded docs) or "mindgraph" (connect to existing MindGraph graph)
    source: str = "upload"
