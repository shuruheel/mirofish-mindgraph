...
- We need to simulate the reactions of all parties involved in public opinion events and the information propagation paths
...
- The text will feature various people, such as "elementary school teachers", "bystanders", "random netizens"
...
- Organization: Any organization/institution (used when no specific organization type applies)
...
4. All entity types must be real-world actors that can post and speak publicly, not abstract concepts
...
"""
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # MindGraph API limits: max 10 custom entity types, max 10 custom edge types
        MAX_ENTITY_TYPES = 10
        MAX_EDGE_TYPES = 10
    ...
    def generate_python_code(self, ontology: Dict[str, Any]) -> str:
        ...
        code_lines = [
            ...
            '# MindGraph uses 56 built-in node types; these definitions are for reference only',
