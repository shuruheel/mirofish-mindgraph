    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Create new simulation instance, fetch simulation world parameter templates
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Automatically parse entities and relations from the knowledge graph, initialize simulation individuals, and give them unique behaviors and memories based on reality seeds
          </p>
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">Current Related Topics</span>
            </div>
          </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            LLM intelligently configures world time flow, recommendation algorithms, individual active hours, posting frequency, event triggers, and other parameters based on simulation requirements and reality seeds
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="simulationStatus === 'running'" class="badge processing">In Progress</span>
            <span v-else-if="phase >= 4" class="badge success">Ready</span>
            <span v-else class="badge pending">Waiting</span>
          </div>
        </div>
        ...
        <div class="card-content">
          ...
          <div class="action-group dual">
            ...
            >
              {{ hasSimulationRun ? 'View Simulation ➝' : 'Start Dual-World Parallel Simulation ➝' }}
            </button>
          </div>
        </div>
      </div>
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      if (res.data.task_id) {
        ...
        addLog(`Preparation task already in progress, resuming polling...`)
      }

      // Set expected total agents immediately (from prepare API response)
      if (res.data.expected_entities_count) {
        expectedTotal.value = res.data.expected_entities_count
        addLog(`Read ${res.data.expected_entities_count} entities from MindGraph`)
...
// Watch simulationId changes (may be set after component mount)
